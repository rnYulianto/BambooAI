...
function initializeThreadsUI() {
    ...
    const uiHTML = `
        ...
        <div class="threads-footer" style="margin-top:12px; font-size:12px; text-align:center; color:#888; display:flex; align-items:center; justify-content:center; gap:6px;">
            <span>Powered by</span>
            <img src="/static/image/bambooai-logo.png" alt="BambooAI Logo" style="height:52px;">
        </div>
    `;
