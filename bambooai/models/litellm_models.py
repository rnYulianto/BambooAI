...
def llm_call(messages: str,model: str,temperature: str,max_tokens: str, response_format: str = None, provider: str = 'openai'):  
    init(provider)

    def get_response(model, provider, messages, temperature, max_tokens, response_format):
        response = completion(
...
def llm_stream(prompt_manager, log_and_call_manager, output_manager, chain_id: str, messages: str,model: str,temperature: str,max_tokens: str,tools: str = None, response_format: str = None, reasoning_models: list = None, reasoning_effort:str = "medium", provider: str = 'openai'):  
    collected_chunks = []
    collected_messages = []
    tool_calls = []
    search_triplets = []
